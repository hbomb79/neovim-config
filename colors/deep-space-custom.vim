" Custom Deep Space - An intergalactically friendly color scheme for Vim
...
set background=dark
let g:colors_name = 'haz-deep-space'
...
call s:HL('SignColumn',                     s:gray2,    'none',    '')
call s:HL('LineNr',                         '#634691',   'none',         '')
...
" Vim-Signify
call s:HL('SignifySignAdd',                 s:green,    'none',         '')
call s:HL('SignifySignChange',              s:yellow,   'none',         'none')
call s:HL('SignifySignDelete',              s:red,      'none',         'none')

hi LspDiagnosticsUnderlineHint guifg=#9ba1ab ctermfg=247 guibg=NONE ctermbg=NONE gui=italic cterm=NONE
...
hi LspDiagnosticsVirtualTextError guifg=#f44747 ctermfg=203 guibg=NONE ctermbg=NONE gui=italic cterm=NONE
hi LspDiagnosticsVirtualTextWarning guifg=#ff8800 ctermfg=208 guibg=NONE ctermbg=NONE gui=italic cterm=NONE
hi LspDiagnosticsVirtualTextInformation guifg=#ffcc66 ctermfg=221 guibg=NONE ctermbg=NONE gui=italic cterm=NONE
hi LspDiagnosticsVirtualTextHint guifg=#4fc1ff ctermfg=75 guibg=NONE ctermbg=NONE gui=italic cterm=NONE
hi MatchParen cterm=underline ctermbg=6 gui=underline guifg=#c47ebd guibg=None

" Buffer tab lines
call s:HL('BufferCurrent', s:purple, s:gray3, '')
call s:HL('BufferCurrentIndex', s:gray1, s:gray3, '')
call s:HL('BufferCurrentMod', s:red, s:gray3, '')
call s:HL('BufferCurrentSign', s:purple, s:gray3, '')
call s:HL('BufferCurrentTarget', s:gray4, s:gray3, '')

call s:HL('BufferVisible', s:gray4, s:gray1, '')
call s:HL('BufferVisibleIndex', s:gray1, s:gray4, '')
call s:HL('BufferVisibleMod', s:gray1, s:gray1, '')
call s:HL('BufferVisibleSign', s:purple, s:gray1, '')
call s:HL('BufferVisibleTarget', s:gray1, s:gray4, '')

call s:HL('BufferInactive', s:gray4, s:gray1, '')
call s:HL('BufferInactiveIndex', s:gray1, s:gray1, '')
call s:HL('BufferInactiveMod', s:red, s:gray1, '')
call s:HL('BufferInactiveSign', s:gray4, s:gray1, '')
call s:HL('BufferInactiveTarget', s:gray1, s:gray1, '')
